classdef BatchNorm < dagnn.ElementWise
  ...
  methods
    function outputs = forward(obj, inputs, params)
      if strcmp(obj.net.mode, 'test') || obj.freeze
    ...
    function [derInputs, derParams] = backward(obj, inputs, params, derOutputs)
      if obj.freeze
        ...
        if isfield(obj.net.meta, 'curBatchSize')
          derParams{3} = derParams{3} * obj.net.meta.curBatchSize ; % this is important as the nFrames might have been pooled before the Loss layer
        else
